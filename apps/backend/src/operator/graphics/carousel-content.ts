...
export function carouselInstruction(brief: CarouselBrief): string {
  return [
    ...
    'twice a deck; it is seasoning, not a voice.',
    '',
    'Shape:',
    ...
    '',
    'Rules:',
    '- 3 to 6 slides — most good decks land at 4 or 5. NEVER pad: a slide that',
    '  only says "save this", restates another slide, or exists to reach a',
    '  count is worse than no slide — cut it and ship fewer.',
